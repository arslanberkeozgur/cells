...
class vector():
    ...
    def dist_between(self, v1, rnd=16):
        v = [i[0] for i in self.itself]
        v1 = [i[0] for i in v1.itself]
        dist = round(__import__('math').dist(v,v1), rnd)
        return dist
